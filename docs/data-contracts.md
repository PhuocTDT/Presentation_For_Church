...
- Named Tunnel: đặt **Public URL** trong sidebar Kênh Band (`#bpPublicUrl`) = domain cố định **thủ công 1 lần** (chưa auto-fill — sẽ làm ở wizard "Cài đặt nâng cao", vì cần capture domain lúc `route dns`).
